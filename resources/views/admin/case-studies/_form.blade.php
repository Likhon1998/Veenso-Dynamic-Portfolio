...
<div class="form-grid">
    ...
    <div class="form-group">
        ...
        <textarea id="challenge" name="challenge" class="form-control">{{ old('challenge', $item?->challenge) }}</textarea>
    </div>
    <div class="form-group">
        <label for="strategy">Strategy</label>
        <textarea id="strategy" name="strategy" class="form-control">{{ old('strategy', $item?->strategy) }}</textarea>
    </div>
    <div class="form-group">
        <label for="implementation">Implementation</label>
        <textarea id="implementation" name="implementation" class="form-control">{{ old('implementation', $item?->implementation) }}</textarea>
    </div>
    <div class="form-group">
        <label for="results">Results</label>
        <textarea id="results" name="results" class="form-control">{{ old('results', $item?->results) }}</textarea>
    </div>
